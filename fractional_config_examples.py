    ...
    def get_conservative_config(self) -> Dict:
        ...
        return {
            ...
            'account_sizing': [
                ...
                AccountSizeConfig(2500, 100000000, (15, 35), 4, 250, "Larger accounts - conservative allocation")
            ],
    ...
    def get_balanced_config(self) -> Dict:
        ...
        return {
            ...
            'account_sizing': [
                ...
                AccountSizeConfig(2000, 100000000, (25, 50), 6, 200, "Large accounts - your original spec")
            ],
    ...
    def get_aggressive_config(self) -> Dict:
        ...
        return {
            ...
            'account_sizing': [
                ...
                AccountSizeConfig(2500, 100000000, (40, 100), 8, 200, "Large accounts - maximum growth")
            ],
    ...
    def get_small_account_config(self) -> Dict:
        ...
        return {
            ...
            'account_sizing': [
                ...
                AccountSizeConfig(1000, 100000000, (10, 25), 5, 100, "Graduating to medium account")
            ],
    ...
    def get_large_account_config(self) -> Dict:
        ...
        return {
            ...
            'account_sizing': [
                ...
                AccountSizeConfig(10000, 100000000, (75, 200), 8, 1000, "Large account maximum")
            ],
...
def main():
    ...
    for tier in custom_config['account_sizing']:
        ...
        print(f"  ${tier.min_account:,}-${tier.max_account:,}: ${min_trade:.2f}-${max_trade:.2f} per trade, max {tier.max_additions} additions")
