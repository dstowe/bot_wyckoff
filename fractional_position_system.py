...
# ✅ FIXED: Import from extracted packages
from database import EnhancedTradingDatabase, WyckoffSignal, DayTradeCheckResult
from compliance import RealAccountDayTradeChecker

# Import strategies and config
from strategies.wyckoff.wyckoff import WyckoffPnFStrategy
from strategies.wyckoff.enhanced_analyzer import EnhancedWyckoffAnalyzer, WyckoffWarningSignal
...
class DynamicAccountManager:
    ...
    def _calculate_conservative_parameters(self, total_value: float, total_cash: float, accounts: List) -> Dict:
        ...
        if total_cash < 100:
            ...
            max_positions = 40
            min_balance_pct = 0.001  # Keep .1% cash
        elif total_cash < 300:
            ...
            base_position_pct = 0.50  # 15% of total cash
            max_positions = 200
            min_balance_pct = 0.0001  # Keep .1% cash
        ...
        return {
            ...
            'min_cash_buffer_per_account': 5  # Keep $15 minimum in each account
        }
