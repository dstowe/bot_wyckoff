class urls :
    ...
    def orders(self, account_id, page_size):
        return f'{self.base_ustradebroker_url}/trade/v2/option/list?secAccountId={account_id}&startTimeStr="1970-01-01"&dateType=ORDER&pageSize={page_size}&status='
    ...
    def paper_orders(self, paper_account_id, page_size):
        return f'{self.base_paper_url}/paper/1/acc/{paper_account_id}/order?&startTimeStr="1970-01-01"&dateType=ORDER&pageSize={page_size}&status='
